function game(){
	...
	this.jiaodu=[0,0,10,0,-5,10,20,0,0,0,0,0];
...
game.prototype={
	...
	createEle:function(num){
		...
		for (var i = 0; i < arr.length; i++) {
			...
			span.style.cssText="display:block;position:absolute;height:250px;width:139px;font-size:30px;font-family:Arial;color:rgba(255,255,255,0);top:"+(-300*Math.random()-85)+"px;left:"+(50+Math.random()*(this.width-200))+"px;background: url(img/"+arr[i]+".png) no-repeat center center;background-size:80px 240px;transform:rotate("+this.jiaodu[Math.floor(Math.random()*this.jiaodu.length)]+"deg)";
